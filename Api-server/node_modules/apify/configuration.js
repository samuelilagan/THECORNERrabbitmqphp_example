...
class Configuration extends (_b = core_1.Configuration) {
    ...
    static getGlobalConfig() {
        if (_a.storage.getStore()) {
            return _a.storage.getStore();
        }
        _a.globalConfig ?? (_a.globalConfig = new _a());
        return _a.globalConfig;
    }
    /**
...
Object.defineProperty(Configuration, "BOOLEAN_VARS", {
    ...
    configurable: true,
    writable: true,
    value: [...Reflect.get(_b, "BOOLEAN_VARS", _a), 'isAtHome', 'testPayPerEvent', 'useChargingLogDataset']
});
