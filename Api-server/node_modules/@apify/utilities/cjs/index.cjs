...
function betterSetInterval(func, delay) {
  ...
  const funcWrapper = /* @__PURE__ */ __name(function() {
    void new Promise((resolve) => resolve(func(() => void 0))).finally(scheduleNextRun);
  }, "funcWrapper");
...
function createHmacSignature(secretKey, message) {
  const signature = import_crypto3.default.createHmac("sha256", secretKey).update(message).digest("hex").substring(0, 30);
