...
//trying to allow port 3001 to access the stylesheets + slicknav
app.get('/slicknav.css', (req, res) => {
  res.sendFile(path.join(__dirname, 'slicknav.css'));
 });

app.get('/corner.css', (req, res) => {
  res.sendFile(path.join(__dirname, 'corner.css'));
 });
 
app.get('https://code.jquery.com/jquery-3.6.0.min.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'https://code.jquery.com/jquery-3.6.0.min.js'));
 });
 app.get('/jquery.slicknav.min.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'jquery.slicknav.min.js'));
 });
