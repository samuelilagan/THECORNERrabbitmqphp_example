...
const dbConfig = {
    ...
    database: process.env.MYSQL_DATABASE || 'localtest'
};
...
(async () => {
    try {
        ...
        for (const reviews of items) {
          ...
          console.log(`Checking if data exists: ${placeName}, ${placeAddress}, ${provider}, ${reviewText}, ${reviewDate}, ${reviewRating}, ${authorName}`);
          ...
          if (rows.length === 0) {
              ...
              console.log(`Inserted new data: ${placeName}, ${reviewText}`);
          } else {
              console.log(`Duplicate data found for ${reviewText}, skipping.`);
          }
      }
